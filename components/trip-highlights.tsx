  ...
  return (
    <section className="bg-gradient-to-r from-emerald-50 to-teal-50 py-12">
      <div className="container">
        <h2 className="text-2xl font-bold tracking-tight mb-8">{t("tripHighlights")}</h2>

        {/* Birthday celebration card */}
        <div className="mb-8 p-6 rounded-lg bg-white shadow-sm border border-pink-100 flex flex-col md:flex-row items-center gap-6">
          <div className="flex-shrink-0">
            <div className="h-24 w-24 md:h-28 md:w-28 rounded-full overflow-hidden border-4 border-pink-200">
              <img
